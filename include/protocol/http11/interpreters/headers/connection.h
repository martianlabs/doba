...
#ifndef martianlabs_doba_protocol_http11_interpreters_h_connection_h
#define martianlabs_doba_protocol_http11_interpreters_h_connection_h
...
// +---------------------------------------------------------------------------+
// | Intra-header semantic interpreter for the Connection header. It consumes  |
// | the parsed_token_list produced by the syntactic checker and mutates the   |
// | hop-by-hop connection state: it records every connection-option token in  |
// | order and, when the "close" option is present (case-insensitively), it    |
// | marks the connection as non-persistent.                                   |
// |                                                                           |
// | Connection option comparison is case-insensitive per RFC 9110 §7.6.1.     |
// | Recognizing an option as naming another (hop-by-hop) header field is a    |
// | transversal concern and is intentionally left to the rules layer.         |
// +---------------------------------------------------------------------------+
// /////////////////////////////////////////////////////////////////////////////
class connection {
 public:
