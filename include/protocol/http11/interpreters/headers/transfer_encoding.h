...
#ifndef martianlabs_doba_protocol_http11_interpreters_h_transfer_encoding_h
#define martianlabs_doba_protocol_http11_interpreters_h_transfer_encoding_h
...
// +---------------------------------------------------------------------------+
// | Intra-header semantic interpreter for the Transfer-Encoding header. It    |
// | consumes the parsed_parameter_list produced by the syntactic checker      |
// | (each element being a transfer-coding with its optional parameters) and   |
// | records the ordered transfer-coding names on the connection state. The    |
// | final transfer-coding decides framing: when it is "chunked" the message   |
// | body is chunk-delimited and conn.chunked is set.                          |
// |                                                                           |
// | Policy is enforced here because Transfer-Encoding limits are per-header:  |
// | a transfer-coding count above policies.max_transfer_codings, or a chunked |
// | coding when policies.allow_chunked is false, yields verdict::kReject.     |
// | Whether "chunked" being non-final is a fatal framing error is a           |
// | transversal (framing) concern left to the rules layer.                    |
// +---------------------------------------------------------------------------+
// /////////////////////////////////////////////////////////////////////////////
