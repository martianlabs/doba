...
#ifndef martianlabs_doba_protocol_http11_checkers_h_forwarded_h
#define martianlabs_doba_protocol_http11_checkers_h_forwarded_h
...
// | OWS               | *( SP / HTAB )                                        |
// +---------------------------------------------------------------------------+
// | RFC 7239 §6 Node Identifiers                                              |
// +---------------------------------------------------------------------------+
// +-------------------+-------------------------------------------------------+
// | Field             | Definition                                            |
// +-------------------+-------------------------------------------------------+
// | node              | nodename [ ":" node-port ]                            |
// | nodename          | IPv4address / "[" IPv6address "]" / "unknown" /       |
// |                   | obfnode                                               |
// | IPv4address       | <RFC 3986 §3.2.2 IPv4address>                         |
// | IPv6address       | <RFC 3986 §3.2.2 IPv6address>                         |
// | obfnode           | "_" 1*( ALPHA / DIGIT / "." / "_" / "-" )             |
// | node-port         | port / obfport                                        |
// | port              | 1*5DIGIT                                              |
// | obfport           | "_" 1*( ALPHA / DIGIT / "." / "_" / "-" )             |
// +---------------------------------------------------------------------------+
// | RFC 7239 §5 Parameter value constraints                                   |
// +---------------------------------------------------------------------------+
// +-------------------+-------------------------------------------------------+
// | Parameter         | Value constraint after quoted-string unescaping       |
// +-------------------+-------------------------------------------------------+
// | by                | node                                                  |
// | for               | node                                                  |
// | host              | Host                                                  |
...
// |                                                                           |
// |   1#forwarded-element =                                                   |
// |     forwarded-element *( OWS "," OWS forwarded-element )                  |
// |                                                                           |
// | Recipient syntax:                                                         |
// |                                                                           |
// |   1#forwarded-element =                                                   |
// |     *( "," OWS ) forwarded-element                                        |
// |     *( OWS "," [ OWS forwarded-element ] )                                |
// |                                                                           |
// | Senders MUST NOT generate empty list elements. Recipients MUST parse and  |
// | ignore a reasonable number of empty list elements.                        |
// |                                                                           |
// | Since the rule is "1#forwarded-element", at least one non-empty           |
// | forwarded-element is required by the purely syntactic ABNF.               |
// +---------------------------------------------------------------------------+
