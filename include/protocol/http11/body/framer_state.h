...
#ifndef martianlabs_doba_protocol_http11_body_framer_state_h
#define martianlabs_doba_protocol_http11_body_framer_state_h

#include <cstddef>
#include <cstdint>

#include "protocol/http11/body/framer_error.h"
