...
#ifndef martianlabs_doba_protocol_http11_limits_h
#define martianlabs_doba_protocol_http11_limits_h
...
// | (verbatim or overridden) when populating protocol::http11::policies. It   |
...
// | protocol::http11::policies field.                                         |
// +---------------------------------------------------------------------------+
// /////////////////////////////////////////////////////////////////////////////
struct limits {
  // Maximum accepted request-target length, in octets. A request-target
  // longer than this is rejected with 414 URI Too Long (RFC 9110 §15.5.15).
  ...
  // rejected with 413 Content Too Large (RFC 9110 §15.5.14).
  ...
  // §7.1.1). Shared by body::framer_chunked and body::reader_chunked.
  ...
  // §7.1.2). Shared by body::framer_chunked and body::reader_chunked. A
  // chunked trailer is itself a header-field section (RFC 9112 §7.1.2), so
