...
#ifndef martianlabs_doba_protocol_http_headers_sec_websocket_version_h
#define martianlabs_doba_protocol_http_headers_sec_websocket_version_h
...
// +===========================================================================+
// | RFC 6455 S11.3.5 Sec-WebSocket-Version                                    |
// +---------------------------------------------------------------------------+
...
// +---------------------------------------------------------------------------+
// | RFC 6455 S11.3.5 Sec-WebSocket-Version (ABNF summary)                     |
// +---------------------------------------------------------------------------+
// +-----------------------+---------------------------------------------------+
// | Field                 | Definition                                        |
// +-----------------------+---------------------------------------------------+
