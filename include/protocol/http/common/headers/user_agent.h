...
#ifndef martianlabs_doba_protocol_http_headers_user_agent_h
#define martianlabs_doba_protocol_http_headers_user_agent_h
...
// +---------------------------------------------------------------------------+
// | RFC 9110 S10.1.5 User-Agent (ABNF summary)                                |
// +---------------------------------------------------------------------------+
// +-----------------+---------------------------------------------------------+
// | Field           | Definition                                              |
// +-----------------+---------------------------------------------------------+
...
// +---------------------------------------------------------------------------+
// | User-Agent is not a list-based field: it does not use the RFC 9110 S5.6.1 |
...
class user_agent {
 public:
  ...
  static constexpr bool check(std::string_view sv) {
    ...
    // 9110 S5.6.1 "#" list: the value MUST begin with a product, items are
    // separated by RWS (not commas), and this is the same product-list shape
    // shared with the Server header field (RFC 9110 S10.2.4).
