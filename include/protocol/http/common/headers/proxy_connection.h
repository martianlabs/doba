...
#ifndef martianlabs_doba_protocol_http_headers_x_proxy_connection_h
#define martianlabs_doba_protocol_http_headers_x_proxy_connection_h
...
class x_proxy_connection {
 public:
  ...
  static constexpr bool check(std::string_view sv) {
    ...
    // header (RFC 9110 S7.6.1). Since the rule is "#connection-option" (not
