...
#ifndef martianlabs_doba_common_console_logger_windows_h
#define martianlabs_doba_common_console_logger_windows_h
...
// /////////////////////////////////////////////////////////////////////////////
// +---------------------------------------------------------------------------+
// | [>] console_logger [windowsTM]                                 ( class )  |
// +---------------------------------------------------------------------------+
// /////////////////////////////////////////////////////////////////////////////
class console_logger {
 ...
 private:
  ...
  void write(console_log_level level, std::string_view message,
    ...
    if (enable_colors() && _isatty(_fileno(stdout))) {
