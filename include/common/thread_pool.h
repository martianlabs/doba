...
// | [>] thread_pool                                                 ( class ) |
// +---------------------------------------------------------------------------+
// | This specification holds for a [cross-platform] thread pool.              |
// +---------------------------------------------------------------------------+
// /////////////////////////////////////////////////////////////////////////////
class thread_pool {
 public:
      ...
      workers_.emplace([this] {
        for (;;) {
          ...
          try {
            ...
            // A task must never terminate a worker thread. Swallow any
            // exception here; the caller is responsible for its own
            // error handling before enqueuing work.
          }
        }
      });
    }
