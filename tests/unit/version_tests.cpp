...
DOBA_TEST("version stringification expands macro arguments") {
  ...
  DOBA_EXPECT_EQUAL(
      std::string_view(DOBA_VERSION_STRINGIFY(DOBA_VERSION_MAJOR)),
      std::to_string(DOBA_VERSION_MAJOR));
  DOBA_EXPECT_EQUAL(
      std::string_view(DOBA_VERSION_STRINGIFY_IMPL(DOBA_VERSION_MAJOR)),
      "DOBA_VERSION_MAJOR");
}
