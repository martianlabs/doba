...
DOBA_TEST("absolute URI parsing preserves every component view") {
  ...
  constexpr test_case cases[] = {
      ...
      {"http://[::1]:/path", "http", "[::1]", "", "/path", "", true},
      {"http://[v1.name]/path", "http", "[v1.name]", "", "/path", "", true},
      {"http://[vF.a:b]:009/path", "http", "[vF.a:b]", "009", "/path", "",
       true},
      {"http://[v1.name]:/path", "http", "[v1.name]", "", "/path", "", true},
...
DOBA_TEST("absolute URI errors distinguish truncation from syntax") {
  ...
  constexpr test_case cases[] = {
      ...
      {"http://[::1]junk/", deserialization_status::kInvalidSource},
      {"http://[::1]80/", deserialization_status::kInvalidSource},
      {"http://[::1]%3A80/", deserialization_status::kInvalidSource},
      {"http://[::1];x?y=1", deserialization_status::kInvalidSource},
      {"http://[::1]]", deserialization_status::kInvalidSource},
      {"http://[v1.name]junk/", deserialization_status::kInvalidSource},
      {"http://[v1.name]80?x=1", deserialization_status::kInvalidSource},
      {"https://[vF.a:b]!/", deserialization_status::kInvalidSource},
      {"http://[::1]:x/", deserialization_status::kInvalidSource},
