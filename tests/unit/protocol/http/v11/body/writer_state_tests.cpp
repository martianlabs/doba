...
#include "protocol/http/v11/body/writer_state.h"
#include "test_helper.h"

namespace {
using martianlabs::doba::protocol::http::v11::body::writer_error;
using martianlabs::doba::protocol::http::v11::body::writer_state;
}  // namespace
